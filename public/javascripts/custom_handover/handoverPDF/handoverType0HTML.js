...
export function handoverType0HTML(elm, dataDate, typeComponentObj) {
  let htmls = "";
  htmls += `
    ...
    <div class="sender">
        <div><strong style="font-size: 1.1rem;">BÊN NHẬN: ${
  ...
  if (elm.isOpen === true) {
    ...
    htmls += `
                ...
                data-bs-target="#exampleModal" style="width: 200px; height: 50px; position: relative">
                    <a href="/handover/${elm._id}.pdf" id="preview" target="_blank" style="    position: absolute;top: 50%;left: 50%;transform: translate(-50%, -25%);width: 100%;height: 100%;" class="text-decoration-none c-white">
                        <span>In Phiếu</span>
                    </a>
                </button>
            `;
